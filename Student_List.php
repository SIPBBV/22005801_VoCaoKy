...
<html>
    ...
    <body>
        ...
        <a href="Student_Add.php">Thêm sinh viên</a> <br/> <br/>
        <table width="100%" border="1" cellspacing="0" cellpadding="10">
            ...
            <tr>
                ...
                <td>
                    <form method="post" action="Student_Del.php">
                        <input onclick="window.location = 'Student_Edit.php?id=<?php echo $item['sv_id']; ?>'" type="button" value="Sửa"/>
